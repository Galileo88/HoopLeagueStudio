...
Court geometry and surface ordering come from the extracted assets and scene renderers. Text styling, logo size, custom overlay placement, and their ordering are provisional until checked against the running game. This is a floor preview; hoop assembly colors are not represented.
